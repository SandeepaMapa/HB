    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="box">
          <span>Breakfast</span>
          <h4></h4>
          <p>Bringing you the perfect start to your day! 😍
            Join us at our breakfast buffet
            <br><br>
            Open hours  :- 6AM to 11PM <br>
            Capacity    :- 100 Seats<br>
            Starting from Rs. 1500 per person</p>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="box">
          <span>Lunch</span>
          <h4></h4>
          <p>Fantastic spread. Great taste. Warm Ambience. And to top that off, unfailing consistency.
            <br><br>
            Open hours  :- 12PM to 3PM <br>
            Capacity    :- 100 Seats<br>
            Starting from Rs. 2500 per person</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="box">
          <span>Dinner</span>
          <h4></h4>
          <p>Here’s unlimited access to a heavenly spread with flavors across the world!
            <br><br>
            Open hours  :- 7PM to 10PM <br>
            Capacity    :- 100 Seats<br>
            Starting from Rs. 2500 per person</p>
        </div>
      </div>

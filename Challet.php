...
<head>
    ...
    <title>River's Edge - Standard Rooms</title>
...
<!--Header-->
  <?php require('inc/header.php'); ?>
   ...
   <br>
           ...
           <img src="Photos\Rooms\chalet-woods-night.jpg" class="w-100 d-block" height="550"/>
...
<br>
<h6 class=" text1 text-left"><a href="index.php" style="text-decoration:none">HOME</a> &nbsp > &nbsp <a href="Accomodation.php" style="text-decoration:none">ACCOMODATION</a> &nbsp > &nbsp CHALET</h6>

   <!--Topics-->
   <div class="my-5 px-4">
    <h2 class="mt-5 pt-4 mb-4 text-center fw-bold f2">CHALET</h2>
     ...
     <div class="row">
       ...
       <div class="row g-0 p-3 align-items-center">
        <div class="col-md-5 mb-lg-0 ms-5 mb-md-0 mb-3">
          <img src="Photos\Rooms\CWY-Beach-Chalet-1090X610.jpg" class="img-fluid rounded" class="img-fluid rounded">
        </div>
         ...
         <p class="me-0 ms-3">There is a cosy little dining nook and to make it even better, the room comes with tea and coffee making
          ...
          spot to sit back and savour a beverage
           immersed in the nature surrounding after exploring Sigiriya before heading back in to enjoy a rejuvenating rain shower
            ...
            <h6 class="mb-2 ms-3">Rs. 15000 per night</h6> 
        </div>   
  </div>
</div>
</div>      

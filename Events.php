...
<!--Header-->
  ...
  Celebrate your love story amidst plush greenery and the magic of River's Edge Reception.<br>
       This is an OUT OF THIS WORLD venue! We spare no effort in ensuring that all corporate retreats,
       outings and events are carried out with the zest and professionalism required
        to ensure all your events a veritable success.
...
<div class="container">
    ...
    Let us make your dream wedding come to life. Browse through our curation of bespoke experiences, packages, and venues here.
        ...
        <div class="col-md-4 mt-lg-0 mt-md-0 mt-4 text-center">
            <a href="#" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2">Book Venue</a>
            <a href="Photoshoots.php" class="btn btn-sm w-100 btn-outline-dark shadow-none">More details</a>
        </div>
      </div>
        <div class="col-lg-5 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
          <img src="Photos\Front\3rd dec.jpg" class="w-100">
